...
Plot the reduced dimensions of LDA. Note that the number of dimensions we choose is equal to the number of
...
```{r}
knitr::purl("/raleighlab/data1/czou/gbm_perturb/gbm_perturb/R/exploration/gl261_lda_only.Rmd", output = "/raleighlab/data1/czou/gbm_perturb/gbm_perturb/R/exploration/gl261_lda_only.R")
```
