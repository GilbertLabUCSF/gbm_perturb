...
## -------------------------------------------------------------------------------------------------------------------------
knitr::purl("/raleighlab/data1/czou/gbm_perturb/gbm_perturb/R/microenvironment/nmf_microenvironment.Rmd", output = "/raleighlab/data1/czou/gbm_perturb/gbm_perturb/R/microenvironment/nmf_microenvironment.R")
...
OUTPUT.DIR <- sprintf("/raleighlab/data1/czou/gbm_perturb/gbm_perturb_sb28_clean_outputs/nmf/ME/%s", CELL.TYPE)
RES.LIST.PATH <- sprintf("/raleighlab/data1/czou/gbm_perturb/gbm_perturb_sb28_clean_outputs/nmf/ME/%s/%s_res_list_2-40_60.rds", CELL.TYPE, CELL.TYPE)
