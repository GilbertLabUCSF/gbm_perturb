...
OUTPUT.DIR <- sprintf("/raleighlab/data1/czou/gbm_perturb/gbm_perturb_sb28_clean_outputs/nmf/ME/prkdc_included_05pval/%s", CELL.TYPE)
RES.LIST.PATH <- sprintf("/raleighlab/data1/czou/gbm_perturb/gbm_perturb_sb28_clean_outputs/nmf/ME/prkdc_included_05pval/%s/%s_res_list_2-40_60.rds", CELL.TYPE, CELL.TYPE)
