...
PATH_TO_DE_GENES = "/raleighlab/data1/czou/gbm_perturb/gbm_perturb_gbm43_clean_outputs/degenes/noRTNormalized_noRTOnly/deMatSig_adjp05_lfc01.txt"
PATHS_TO_LFC = c("/raleighlab/data1/czou/gbm_perturb/gbm_perturb_gbm43_clean_outputs/deseq/noRTNormalized")
...
OUTPUT_DIR = "/raleighlab/data1/czou/gbm_perturb/gbm_perturb_gbm43_clean_outputs/nmf/noRTNormalized_noRTOnly"
...
# write.table(expr_matrix, paste(OUTPUT_DIR, "output_matrix_lognormalized_lfc_rank20_MaxModules.txt", sep = "/"), sep = "\t")
# 
# # Plot the heatmap
# 
# poi = colnames(expr_matrix)
# ht = Heatmap(expr_matrix,
#         name = "Log Fold Change Matrix Clustered on Rank-20 NMF",
...
# )
# pdf(paste(OUTPUT_DIR, "output_matrix_lognormalized_lfc_rank20_MaxModules_range1_2.pdf", sep = "/"),
#     width=35,
#     height=19,
#     useDingbats=FALSE)
