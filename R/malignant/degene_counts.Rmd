...
This vignette contains code for counting the number of differentially expressed genes for GL261 DESeq output stored in a directory called `data/malignant/deseq/invitro`.
